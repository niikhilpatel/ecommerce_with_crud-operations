    ...
    <div className=" flex justify-center items-center gap-10 px-10">
      {[
        ...
        <div key={index} className="relative shadow-lg w-96">
          ...
          <button className="absolute bottom-5 left-1/2 transform -translate-x-1/2 bg-white text-black py-2 px-4 rounded-full border-2 border-yellow-400 font-semibold shadow-md hover:bg-gray-200 transition-all">
            {category.label}
          </button>
        </div>
      ))}
